...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] fade-in">
      <div className="w-full max-w-sm">
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderTop: '3px solid var(--accent)' }}>
          <div className="px-5 pt-6 pb-5 text-center sm:px-8 sm:pt-8 sm:pb-6">
            <div className="text-4xl mb-3">Drive</div>
          ...
          <form onSubmit={handleSubmit} className="px-5 pb-5 space-y-4 sm:px-8 sm:pb-8">
            <div>
            ...
            <button
              ...
              onMouseEnter={e => { if (!submitting) e.currentTarget.style.background = '#ffc04d' }}
        ...
        <p className="text-center mt-4 text-xs tracking-widest uppercase px-4" style={{ color: 'var(--muted)' }}>
